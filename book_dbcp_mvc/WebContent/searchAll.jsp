...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link active" id="v" data-toggle="pill" href="#all" role="tab" aria-controls="v-pills-profile" aria-selected="false">도서 목록 보기</a>
    ...
    <div class="tab-content" id="v-pills-tabContent">
      ...
      <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="v-pills-home-tab"><table class="table table-striped table-dark" style="padding:10px">
  <thead>
    <tr>
  ...
  <tbody>
	...
	%>
      ...
      <div class="tab-pane fade" id="search" role="tabpanel" aria-labelledby="v-pills-settings-tab"><jsp:include page="view/search.jsp"/></div>
